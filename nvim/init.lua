...
vim.keymap.set('n', '<leader>h', require('telescope.builtin').oldfiles, { desc = '[?] Find old files' })
...
vim.keymap.set('n', '<C-o>', vim.diagnostic.open_float, { desc = "Open floating diagnostic message" })
vim.keymap.set('n', '<C-f>', vim.lsp.buf.formatting, { desc = "Formatting file" })
